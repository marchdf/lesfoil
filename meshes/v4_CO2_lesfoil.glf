...
# attempt at removing mesh kinks
set _TMP(mode_1) [pw::Application begin Modify [list $_CN(2)]]
$_TMP(mode_1) abort
unset _TMP(mode_1)
set _TMP(mode_1) [pw::Application begin Modify [list $_CN(1)]]
  pw::Connector swapDistribution Growth [list [list $_CN(1) 1]]
  [$_CN(1) getDistribution 1] setBeginLayers 50
  [$_CN(1) getDistribution 1] setBeginRate 1.01
  [$_CN(1) getDistribution 1] setEndLayers 50
  [$_CN(1) getDistribution 1] setEndRate 1.01
$_TMP(mode_1) end
unset _TMP(mode_1)
pw::Application markUndoLevel Distribute
...
set _TMP(mode_1) [pw::Application begin Modify [list $_CN(1)]]
  pw::Connector swapDistribution Growth [list [list $_CN(1) 2] [list $_CN(1) 1]]
  [$_CN(1) getDistribution 2] setBeginLayers 50
  [$_CN(1) getDistribution 2] setBeginRate 1.01
  [$_CN(1) getDistribution 2] setEndLayers 50
  [$_CN(1) getDistribution 2] setEndRate 1.01
$_TMP(mode_1) end
unset _TMP(mode_1)
pw::Application markUndoLevel Distribute
...
lappend _TMP(split_params) [$_CN(26) getParameter -closest [pw::Application getXYZ [$_CN(26) getXYZ -parameter 0.168]]]
lappend _TMP(split_params) [$_CN(26) getParameter -closest [pw::Application getXYZ [$_CN(26) getXYZ -parameter 0.666]]]
